                    ...
                    <div class="post_row">
                        <div class="post_col post_col-2 inview slide_up_animation">
                            ...
                            {{-- <p> <span style="font-size: 25px; font-weight: bold;">経営の目的</span> </br> --}}
                              私は18歳で上京してから世田谷での居住歴25年（学生時代から社会人まで一人暮らしで現在は３世帯同居）、小学校のPTA会長なども経験させていただきました。そこで培った経験が地元の方々との繋がり、そして土地や物件情報にも活きております。様々なシチュエーションを想定しながら、一人ひとりのお客様に最適な住まいをお届けするため、日々努めております。地域の不動産を熟知することで、住まい探しに関するあらゆるニーズにお応えできる体制を整えております。</br>
                              また、上京してくる学生の皆さんには、特に温かい支援を提供したいと考えております。初めての都会生活に不安を抱える学生の方々が、安心して新生活を始められるよう、物件の選定から入居後のサポートまで一貫したサービスを心掛けています。学業に専念できる環境作りのお手伝いをすることは、弊社を起業した目的であり私にとって大切な使命です。</br>
                              さらに、今後は地域の主婦層の雇用促進にも力を入れています。PTA活動を通じて主婦の方々のビジネス能力の高さを感じることができました。家庭と両立しやすい柔軟な働き方を提供させていただき、きめ細やかな対応ができる地元に根差した主婦の方々と、お客様に寄り添い心温まるサービスを強みにしていくことが目標です。</br>
                              今後も「地域に根ざし、地域を支える」をモットーに、より多くの方々に喜ばれる賃貸サービスを提供してまいります。どうぞよろしくお願い申し上げます。</br></br>
                              代表取締役 立川　宰輝
                            </p>
