                ...
                <div class="gray_bg" id="company_message">
                    ...
                    <div class="post_row">
                        <div class="post_col post_col-2 inview slide_up_animation">
                            ...
                            早速ではございますが、社名となる「BATON」の由来は<span style="text-decoration: underline;font-weight: bold;" > 次世代へ繋いでいく。</span>との想いを持っております。昨今の社会情勢、気候変動より、今後は今以上に厳しい生活環境が想定されます。今、弊社ができることは限られていると思いますが、できることを一つ一つ実現していくことにより、次世代の方々へ良いカタチで「BATON」を受け渡していきたいと考えます。まずは不動産業にて価格、サービス両面において、業界のイメージを払拭すべく、透明性の高く、質の高いコミュニケーションを心掛けて、お客様に理想の物件をお届けできるよ、しっかりと努めてまいります。</br>
                            また、具体的な支援策としては下記２点を掲げさせていただいております。</br></br>

                            1.上京学生への支援</br>
                            上京してくる学生の皆さんには、特に温かい支援を提供したいと考えております。初めての都会生活に不安を抱える学生の方々が、安心して新生活を始められるよう、物件の選定から入居後のサポートまで一貫したサービスを心掛けています。学業に専念できる環境作りのお手伝いをすることは、弊社を起業した目的であり私にとって大切な使命です。
                            </br></br>

                            2.主婦の方々の雇用環境支援</br>
                            私自身PTA活動を通じて主婦の方々のビジネス能力の高さを感じることができました。家庭と両立しやすい柔軟な働き方を提供させていただき、きめ細やかな対応ができる地元に根差した主婦の方々と、お客様に寄り添い心温まるサービスを強みにしていくことが目標です。
                            </br></br>
                            引き続きより多くの方々に喜ばれる賃貸サービスを提供してまいります。今後ともよろしくお願い申し上げます。</br></br>
                            代表取締役 立川宰輝
                            </p>
