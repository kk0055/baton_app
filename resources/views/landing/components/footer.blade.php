<footer id="footer">
    <div id="footer_inner">
        ...
        <div id="footer_address" class="post_content clearfix">
            <p>物件に関するお問い合わせは <span><a href="https://docs.google.com/forms/d/1OGoRCunJpDpYy6aYS-DGVoTodgmLvII9Qz4A9ipEYyc/viewform?edit_requested=true"
              target="_blank">こちら</a></span> よりお気軽にご連絡ください。</p>
        </div>
